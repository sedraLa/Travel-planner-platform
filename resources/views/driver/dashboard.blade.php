...
<x-app-layout>
    ...
    <div class="driver_profile">
        <div class="personal_info">
            <img class="personal-photo" src="{{asset('images/ian-dooley-d1UPkiFd04A-unsplash.jpg')}}">
            <div class="personal-details">
                <span>Good day</span>
                <h2>Welcome back, Micheal <!--drver name--> 👋</h2>
                <p id="rating">⭐ 4.9 rating <!--rating--> . 342 total trips <!--assigned completed bookings number--></p>
            </div>
        </div>
    </div>
    <div class ="bookings-summary">
        ...
        <div class ="pending">
            ...
            <div class="count">
            <h3>PENDING</h3>
            <span id="pending-total">2 <!--number of pending booings--> </span>
            </count>
            </div>
        </div>
        ...
        <div class ="completed">
            ...
            <div class="count">
            <h3>COMPLETED</h3>
            <span id="completed-total">2 <!--number of pending booings--> </span>
            </count>
            </div>
        </div>
        ...
        <div class ="canceled">
            ...
            <div class="count">
            <h3>CANCELED</h3>
            <span id="canceled-total">2 <!--number of pending booings--> </span>
            </count>
            </div>
        </div>
    ...
    <div class="assigned-vehicle">
        ...
        <div class="vehicle-info">
            <img class="vehicle-photo" src="{{ asset('images/cari-kolipoki-rEmiiyRZi8g-unsplash.jpg') }}" alt="Vehicle Image">

            <div class="vehicle-details">
                <h2 class="vehicle-model">MERCEDES-BENZ</h2>
