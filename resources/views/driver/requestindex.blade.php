...
<x-app-layout>
    ...
    <div class="main-wrapper p-6 md:p-8"> 
          ...
          {{-- Search Form  --}}
          <form method="GET" action="{{ route('drivers.request.index') }}" class="flex flex-wrap gap-4 items-end mb-6">
            {{-- Keyword --}}
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('drivers.request.index') }}" class="px-4 py-2 border rounded-lg text-gray-600">Reset</a>
            </div>
        </form>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <div class="p-6 border-b border-gray-200">
                ...
                <h2 class="text-2xl font-bold text-gray-800">Driver Requests List</h2>
                <p class="text-gray-500 mt-1">A list of all the drivers who  send a request</p>
                                {{--Success messages--}}
                                @if (session('success'))
