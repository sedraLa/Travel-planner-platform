        ...
        <form action="{{ route('destinations.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="first-section">
                ...
                <div class="left">
                    ...
                    <x-text-input id="location_details" type="text" name="location_details"
                        :value="old('location_details')" required />

                    <x-input-label
                        for="iata_code"
                        value="IATA Code (for the most famous airport in this destination)" />
                    <p>
                        you can find the right IATA code here
                        <a target="_blank" href="https://airportcodes.aero/search">IATA-CODES</a>
                    </p>
                    <x-text-input id="iata_code" name="iata_code" type="text" maxlength="3" required />
                    ...
                    <div class="mt-6">
                        ...
                        <input id="images" name="images[]" type="file" multiple
                               ...
                               onchange="showPrimarySelect(this)" />
                    ...
                    <div id="primary-select-wrapper" class="mt-4 hidden">
                        ...
                        <select name="primary_image_index" id="primary_image_index"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"></select>
                ...
                <div class="right">
                    ...
                    <x-text-input id="nearest_airport" type="text" name="nearest_airport"
                        required :value="old('nearest_airport')" />

                    <x-input-label for="best_time_to_visit" value="best_time_to_visit" />
                    <x-text-input id="best_time_to_visit" type="text" name="best_time_to_visit"
                        required :value="old('best_time_to_visit')" />

                    <x-input-label for="emergency_numbers" value="emergency_numbers" />
                    <x-text-input id="emergency_numbers" type="text" name="emergency_numbers"
                        required :value="old('emergency_numbers')" />

                    <x-input-label for="local_tip" value="local_tip" />
                    <x-text-input id="local_tip" type="text" name="local_tip"
                        required :value="old('local_tip')" />
