    ...
    <div class="main-wrapper p-6 md:p-8">
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <div class="p-6 border-b border-gray-200">
                <h2 class="text-2xl font-bold text-gray-800">My Completed Trips</h2>
                <p class="text-gray-500 mt-1">Trips assigned to you and completed based on trip end date.</p>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="px-6 py-4 text-center text-gray-500">No completed trips found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
