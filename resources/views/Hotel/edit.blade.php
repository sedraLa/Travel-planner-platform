                    ...
                    <form method="POST" action="{{ route('destinations.update', $destination->id) }}"
                        ...
                        <div class="flex space-x-4">
                            ...
                            <div class="w-1/2">
                                ...
                                <textarea id="description" name="description"
                                    class="mt-1 block w-full dark:bg-gray-900 dark:text-gray-300">{{ old('description', $destination->description) }}</textarea>
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="activities" name="activities"
                                class="mt-1 block w-full dark:bg-gray-900 dark:text-gray-300">{{ old('activities', $destination->activities) }}</textarea>
                        ...
                        <div class="mt-4">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">You can upload multiple images. The
                                primary image can be changed below.</p>
                        </div>
                        ...
                        <div class="mt-10">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                                @foreach($destination->images as $image)
                                    <div
                                        class="relative group border rounded shadow overflow-hidden h-48 bg-white dark:bg-gray-900">
                                        ...
                                        @else
                                            <span
                                                class="absolute bottom-2 left-2 bg-green-600 text-white text-xs px-3 py-1 rounded shadow">
                                                Primary
                                            </span>
                                        @endif
                                    </div>
