        ...
        <form action="{{ route('vehicle.update', $vehicle->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="first-section">
                <div class="left">
                    ...
                    {{-- 3. استخدام old() مع البيانات الحالية كقيمة احتياطية --}}
                    ...
                    <x-text-input id="driver_name" type="text" name="driver_name" required
                        placeholder="Enter driver name" :value="old('driver_name', $vehicle->driver_name)" />
                    ...
                    <x-text-input id="driver_contact" type="text" name="driver_contact" required
                        placeholder="Enter driver contact" :value="old('driver_contact', $vehicle->driver_contact)" />
                </div>
